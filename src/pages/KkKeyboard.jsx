    ...
    <div className='h-screen bg-gradient-to-br from-orange-500 via-purple-500 to-blue-500 flex justify-center items-center'>
      <div className="w-3/4 md:w-1/2">
        ...
        <div className='mt-4 flex gap-4 items-center justify-center mb-10'>
          <p className="text-white md:text-3xl text-center font-bold">Qaraqalpaqsha klaviatura</p>
        ...
        <ul className='flex flex-col gap-4'>
          <a href='https://kk-keyboard.netlify.app' target='_blank'>
            <li className="bg-white p-4 rounded-md cursor-pointer hover:bg-orange-200 shadow active:scale-95 transition-all active:bg-white flex justify-between items-center gap-4">
              <span className="text-indigo-600 md:text-lg font-semibold">latin_qr</span>
              <div>
                <img src={qoshqarMuyizIcon} alt="Brain icon" className='max-w-10' />
              </div>
            </li>
          </a>
          <a href={hariplerdinJaylasqanOrni} download>
            <li className="bg-white p-4 rounded-md cursor-pointer hover:bg-orange-200 shadow active:scale-95 transition-all active:bg-white flex justify-between items-center gap-4">
              <span className="text-indigo-600 md:text-lg font-semibold">Háriplerdiń jaylasqan ornı</span>
              <div>
                <img src={qoshqarMuyizIcon} alt="Brain icon" className='max-w-10' />
              </div>
            </li>
          ...
          <a href={KkKlaviaturaOrnatiw} download>
            <li className="bg-white p-4 rounded-md cursor-pointer hover:bg-orange-200 shadow active:scale-95 transition-all active:bg-white flex justify-between items-center gap-4">
              <span className="text-indigo-600 md:text-lg font-semibold">Klaviaturanı kompyuterge ornatıw boyınsha qollanba</span>
              <div>
                <img src={qoshqarMuyizIcon} alt="Brain icon" className='max-w-10' />
              </div>
            </li>
